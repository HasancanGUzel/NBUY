...
namespace ShoppingApp.Web.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Index(SearchQueryDto searchQueryDto = null)//ürünler sayfsına ilk tıklandığı zaman arama verisi göndermicez o yüzden ilk değerini null yaptık null ise şu metotolar çalışsın dolu ise şu metotolar çalışşsın dicez
        {
            ...
            var isHomeList=FillIsHomeList(); // ProductSearch daki partial vizmızın içindeki sleectleri dolduruyoruz
            ...
            {
                ProductListDtos= productListDtos, // burada ProductListDto ve SearchQueryDto yu birleştirrerek bir model oluşturduk ve bu modeli index sayfasına gönderdik
        ...
        public async Task<IActionResult> UpdateIsHome(int id,SearchQueryDto searchQueryDto) // buraya gizli inputun içinde ishome isaproved ve searcstring verilerini yolladık çünkü  ürünlerde ishome tiki kaldırınca o sayfa kalsın diye bunları yolladık
        {
        ...
        //{
        //    List<Product> searchResults = await _productService.GetSearchResultsAsync(searchQueryDto.IsApproved, searchQueryDto.IsHome, searchQueryDto.SearchString);
