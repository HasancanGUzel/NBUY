...
builder.Services.AddDbContext<ShopAppContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("MsSqlConnection"))); // bunuda deðiþtik
...
app.UpdateDatabase().Run(); // burada tanýmladýðýmýz MiagrationManager daki metodu çaðýrarak  sayfa her çalýþtýðýnda  eðer yeni bir migrations var onu güncellicek
