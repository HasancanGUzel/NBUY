...
namespace ShoppingApp.Data.Concrete.EfCore.Repositories
{
    public class EfCoreProductRepository : EfCoreGenericRepository<Product>, IProductRepository
    {
        ...
        public async Task<List<Product>> GetSearchResultAsync(string searchString, bool isApporved = true)
        {
            ...
            //bunu sadece anasayfada ürün aramak için yapmıştık ama admin panelinde ürünler sayfasında  admin arama yaptığı zaman görebilmesi için yukarıdaki kodu yazdık
            // searchString = searchString.ToLower();
            //return await ShopAppContext
            //    .Products
