...
namespace ShoppingApp.Business.Abstract
{
    public interface IProductService
    {
        ...
        Task <List<Product>>GetSearchResultAsync(string searchString, bool isApporved=true); // arama çubuğuna girdiğimiz veriye göre o veriyi içeren ürünleri getiricek
    }
}
