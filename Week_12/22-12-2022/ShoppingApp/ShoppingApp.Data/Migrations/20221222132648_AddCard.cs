    ...
    public partial class AddCard : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "8201ec98-f692-44fa-8e3d-7eaf8fdcba68", null, "User rolü", "User", "USER" },
                    { "efd91364-c621-4921-8108-8885940f47c5", null, "Admin rolü", "Admin", "ADMIN" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "Adress", "City", "ConcurrencyStamp", "DateOfBirth", "Email", "EmailConfirmed", "FirstName", "Gender", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[,]
                {
                    { "7364fe28-75cb-4ded-9f2d-df344deda93a", 0, "Akasya cd. Orkide sk.Gül ap.", "İzmir", "fb202063-ffe5-4d47-a577-8649e0ad039e", new DateTime(1985, 10, 29, 0, 0, 0, 0, DateTimeKind.Unspecified), "user@gmail.com", true, "Kemal", "Erkek", "User", false, null, "USER@GMAIL.COM", "USER", "AQAAAAIAAYagAAAAEAv3yjpyVpMrw1F1a2hiwPzigk/hhFSKyMh5K0SZVLJ34vHAswCQ9AJbRMwVh28/1Q==", "44444444444", false, "fd1bb907-e614-43dc-b76f-fad00dc60fd2", false, "user" },
                    { "b1507e7d-8ea8-4785-8575-e9617c5ea30c", 0, "Çek cd. Senet sk.Fatura ap.", "İstanbul", "99345f52-7069-45f5-81f5-d16400068f70", new DateTime(1998, 5, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@gmail.com", true, "Deniz", "Kadın", "Admin", false, null, "ADMIN@GMAIL.COM", "ADMIN", "AQAAAAIAAYagAAAAENmbH7vniPvYyFhAK+kPfTZN5xOoi2yPhMsgHe7yFTwd4D21STklefpCsN948aGnTg==", "5555555555", false, "cf4e4a62-727d-440d-8119-8d30d0e85d95", false, "admin" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "8201ec98-f692-44fa-8e3d-7eaf8fdcba68", "7364fe28-75cb-4ded-9f2d-df344deda93a" },
                    { "efd91364-c621-4921-8108-8885940f47c5", "b1507e7d-8ea8-4785-8575-e9617c5ea30c" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "b1507e7d-8ea8-4785-8575-e9617c5ea30c" },
                    { 2, "7364fe28-75cb-4ded-9f2d-df344deda93a" }
                });
