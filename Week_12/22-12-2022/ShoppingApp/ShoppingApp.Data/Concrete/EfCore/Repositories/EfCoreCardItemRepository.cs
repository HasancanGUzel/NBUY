...
namespace ShoppingApp.Data.Concrete.EfCore.Repositories
{
    public class EfCoreCardItemRepository : EfCoreGenericRepository<CardItem>, ICardItemRepository
    {
        ...
        {
            cardItem.Quantity = quantity; // buraya gelen CardItem yani cardın tüm bilgileri ve adet bilgisi geldi bizde cardItem içindeki quntity yerine dışarıdan gelen quantity i atıyoruz ve
            ShopAppContext.CardItems.Update(cardItem);//buradagüncelliyoruz
        }
