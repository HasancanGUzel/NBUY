...
namespace ShoppingApp.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterDto registerDto)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    ////---------------------------------------
                    await _userManager.AddToRoleAsync(user, "User");//kullancıı ilk kayıt olduğu zaman role veriyoruz
                    //-----------------------------------
        ...
        public async Task <IActionResult> Manage(UserManageDto userManageDto)
        {
            ...
            user.DateOfBirth = userManageDto.DateOfBirth;//tarih için sonradan ekledik
