...
{
    //controlleri extension etme kodu internetten hazır aldık
    //asp net core render partial view to string buradan  https://www.surinderbhomra.com/Blog/2018/09/02/ASPNET-Core-Render-Partial-View-To-String-Outside-Controller-Context sitesi
