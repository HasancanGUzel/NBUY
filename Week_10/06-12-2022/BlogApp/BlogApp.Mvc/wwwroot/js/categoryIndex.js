$(document).ready(function () {  //bunları category views daki index deki script de yazan bölgeyi aldık buraya yapıştırdık
        ...
        buttons: [
            ...
            },
            {
                ...
                action: function (e, dt, node, config) {
                    ...
                    $.ajax({
                        type: 'GET',
                        url: '/Admin/Category/GetAllCategories/',//burada index sayfamızdayken c#kodu ile url almıştık ama burda işe yaramıyor. yani anlamı Admin klasöründeki category controllerındaki  GetAllCategories metodu
    ...
    $(function () {
        const url = '/Admin/Category/Add/'; //yani anlamı Admin klasöründeki category controllerındaki  Add metodu
    ...
    $(function () {
        ...
        $(document).on('click', '.btn-update', function () {
            ...
            $.get(url, { categoryId: id })
                .done(function (data) { // başarılı olma durumunda
                    placeHolderDiv.html(data);
                    placeHolderDiv.find('.modal').modal('show');
                })
                .fail(function () {// başarısız olması durumunda
                    toastr.error('Hata!!!');
                });
        });
