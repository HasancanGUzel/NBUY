...
namespace ShoppingApp.Data.Config
{
    public class ProductConfig : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(p => p.Id).ValueGeneratedOnAdd();// id nin 1 den başlayıp 1er 1 er artmasını sağlar
            ...
            builder.Property(p => p.DateAdded)
                .HasDefaultValueSql("date('now')");// bu sqlite için böyle kullanılır product eklendiği zaman o zamanın tarihi eklemesi için (sqlite da tarih tipi olamdığı için  bu şekil yapılmış)
                                                   //.HasDefaultValueSql("getdate()"); // bu satırda sql ile çalışırken şimdiki tarihi böyle alınabilir
