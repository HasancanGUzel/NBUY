...
namespace ShoppingApp.Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        public async Task CreateProductAsyn(Product product, int[] selectedCategoryIds)
        {
            await _unitOfWork.Products.CreateProductAsync(product, selectedCategoryIds);
            // burda unitofwork u kullnaraka  CreateProductAsync bu metoda  product, selectedCategoryIds verileri yolladık
        }
