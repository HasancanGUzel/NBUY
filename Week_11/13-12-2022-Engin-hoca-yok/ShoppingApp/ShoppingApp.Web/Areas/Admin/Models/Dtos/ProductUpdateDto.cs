...
namespace ShoppingApp.Web.Areas.Admin.Models.Dtos
{
    public class ProductUpdateDto
    {
        ...
        public List<Category> Categories { get; set; } // ürün ekleye tıklandığı zaman ekranın sağında kategorşleri lşstelemek için

        [Required(ErrorMessage = "En az bir kategori seçilmelidir.")]
        public int[] SelectedCategoryIds { get; set; }//seçili olan kategorilerin value yani id lerini burada tutyoruz
    }
}
