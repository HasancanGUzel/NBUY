...
namespace ShoppingApp.Data.Concrete.EfCore.Repositories
{
    public class EfCoreProductRepository : EfCoreGenericRepository<Product>, IProductRepository
    {
        ...
        public async Task UpdateIsHomeAsync(Product product)
        {
            ...
            //    product.IsHome= true;
            //}
            product.IsHome = !product.IsHome; // bu satır üstteki if else in kısa hali üsttekide olur gelen product içindeki IsHome true ise false false ise true yap diyoruz
            ShopAppContext.Update(product); //sonra güncelle ve kaydet
            await ShopAppContext.SaveChangesAsync();
        }
        ...
        public async Task UpdateIsApprovedAsync(Product product)
        {
            ...
            product.IsApproved = !product.IsApproved; //product içindeki IsApproved true ise false false ise true yap diyoruz
