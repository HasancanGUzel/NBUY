...
namespace ShoppingApp.Web.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewBag.SelectedMenu = "Product";//_Admin SideBarPartial da kullandık
            ViewBag.Title = "Ürünler"; // bunuda layout da kullandık hangi sayfaya gidilirse ona göre isim yazıyor title
        ...
        {
            var product = await _productService.GetByIdAsync(id);// tıklanılan inputun id sine göre bilgiler geldi
            if (product ==null)
            {
                return NotFound();
            }
            await _productService.UpdateIsHomeAsync(product);//ef coredaki metoda gönderiyoruz bilgileri ona göre geri dönüş alıcaz
            return RedirectToAction("Index");
        }
