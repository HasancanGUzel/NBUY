...
{
    public class EfCoreGenericRepository<T> : IGenericRepository<T> where T: class  //buraya verilecek olan T mutlaka bir class olmak zorunda
    {
        ...
        {
            return context.Set<T>().ToList(); //buraya gelen T nin yerine karşılık gelen titpi yaz yani Kitap,Ktategori,Yazar yazıcak
        }
